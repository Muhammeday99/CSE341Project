<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="YeniProjeEkle_eskisi.aspx.cs" Inherits="projedeneme2.ProjeTanim.YeniProjeEkle_eskisi" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <br />
            <br />
&nbsp;<asp:Ch&nbsp;<asp:CheckBox ID="activeProject" runat="server" Text="Aktif Proje" TextAlign="Left" OnCheckedChanged="activeProject_CheckedChanged" />
            <br />
            <br />
